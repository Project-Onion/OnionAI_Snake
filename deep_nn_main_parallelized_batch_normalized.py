...
def main(_):
    ...
    workers = [\
        ...
        "10.100.8.48:2222", \
        "10.100.8.50:2222", \
        "10.100.8.51:2222"]  # Needs IP addresses of all nodes in the cluster
    ...
    if FLAGS.job_name == "ps":
        ...
        print("amountOfMiniBatchFilesToTrain: " + str(
            amountOfMiniBatchFilesToTrain) + "\tamountOfMiniBatchFilesToValidate: " + str(
            amountOfMiniBatchFilesToValidate) + "\tamountOfMiniBatchFilesToTest: " + str(amountOfMiniBatchFilesToTest))
        fileLocation = "/scratch/ohanoch/snakeNN_data/  "
