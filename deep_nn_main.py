...
def deepnn(x, keep_prob):
    ...
    #     W_fc0 = weight_variable([2704, 2704]) #4096 = first power of 2 larger than 2500 (=50x50)
    #     b_fc0 = bias_variable([2704])
    #
    #     h_fc0 = tf.nn.relu(tf.matmul(x, W_fc0) + b_fc0)
    #
    # with tf.name_scope('reshape'):
    #     h_fc0_flat = tf.reshape(h_fc0, [-1, 52, 52, 1])
    ...
    # if lastEpoch:
    #     finalNN.append(W_conv1)
    #     finalNN.append(b_conv1)
    #     finalNN.append(W_conv2)
    #     finalNN.append(b_conv2)
...
def main(_):
    ...
    # read loaded data
    # numpyAllData = np.load("/home/student/Desktop/snake_json_files_2_0/allDataFlattenedSphered.npy")
    # numpyAllMoves = np.load("/home/student/Desktop/snake_json_files_2_0/allMoves.npy")
    # numpyAllData = np.load("../snake_json_files/trainDataBoards.npy")
    # numpyAllMoves = np.load("../snake_json_files/trainDataMoves.npy")
    # numpyCombinedData = [numpyAllData,numpyAllMoves]

    # numpyAllTestData = np.load("/home/student/Desktop/snake_json_files_2_0/allTestDataFlattenedSphered.npy")
    # numpyAllTestMoves = np.load("/home/student/Desktop/snake_json_files_2_0/allTestMoves.npy")    # numpyAllData = []
    # numpyAllTestData = np.load("../snake_json_files/testDataBoards.npy")
    # numpyAllTestMoves = np.load("../snake_json_files/testDataMoves.npy")
    # numpyCombinedTestData = [numpyAllTestData, numpyAllTestMoves]

    # numpyAllData.append(np.array(allData[0]))
    # numpyAllData.append(np.array(allData[1]))
    # Create the model
    ...
    with tf.Session() as sess:
        ...
        numEpochs = 1
        sumOfValidations = 0.35 # for starting learning rate multiplier
        ...
        #Trying to get tensorflow server to work, (server now implemented manually)
        # export_path_base = sys.argv[-1]
        # export_path = os.path.join(
        #     tf.compat.as_bytes(export_path_base),
        #     tf.compat.as_bytes(str(FLAGS.model_version)))
        #  export_path = "/home/student/Desktop/saved_modules" + str(FLAGS.model_version)
        ...
        save_path = saver.save(sess, 'output_snake_model')
